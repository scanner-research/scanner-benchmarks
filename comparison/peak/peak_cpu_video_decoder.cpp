...
///////////////////////////////////////////////////////////////////////////////
/// PeakCPUVideoDecoder
PeakCPUVideoDecoder::PeakCPUVideoDecoder(i32 device_id,
...
PeakCPUVideoDecoder::~PeakCPUVideoDecoder() {
...
void PeakCPUVideoDecoder::configure(const FrameInfo& metadata) {
  metadata_ = metadata;
...
bool PeakCPUVideoDecoder::feed(const u8* encoded_buffer, size_t encoded_size,
                                bool discontinuity) {
// Debug read packets
#if 0
...
bool PeakCPUVideoDecoder::discard_frame() {
...
bool PeakCPUVideoDecoder::get_frame(u8* decoded_buffer, size_t decoded_size) {
...
int PeakCPUVideoDecoder::decoded_frames_buffered() {
  return decoded_frame_queue_.size();
}

void PeakCPUVideoDecoder::wait_until_frames_copied() {}

void PeakCPUVideoDecoder::feed_packet(bool flush) {
